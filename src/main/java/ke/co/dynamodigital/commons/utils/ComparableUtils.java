...
public class ComparableUtils {
    ...
    /**
     * Check if value greater than or equal to ref
     *
     * @param value value to check
     * @param ref   reference value to compare against
     * @param <T>   type
     * @return true if value greater than or equal to ref, false otherwise
     */
    public <T extends Comparable<T>> boolean isGreaterThanOrEqualTo(T value, T ref) {
        return value.compareTo(ref) >= 0;
    }
    ...
    /**
     * Check if value less than or equal to ref
     * @param value value to check
     * @param ref reference value to compare against
     * @param <T> type
     * @return true if value is less than or equal to ref
     */
    public <T extends Comparable<T>> boolean isLessThanOrEqualTo(T value, T ref) {
        return value.compareTo(ref) <= 0;
    }
